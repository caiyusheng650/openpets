...
export const zhHans: Partial<Messages> = {
  ...
  "pet.fallback.unavailableBody": "{petId} 未安装，将使用默认宠物。窗口限制仅对已安装的宠物有效，请运行：小灰狼桌宠 mcp --pet <installed-pet-id>",

  // --- Confinement / Screen Recording permission (main process) ---
  "confinement.screenPermission.title": "需要屏幕录制权限",
  "confinement.screenPermission.body": "小灰狼桌宠需要屏幕录制权限才能让宠物保持在窗口内。点击打开系统设置。",
  ...
  "dashboard.reaction.idle": "空闲",
  "dashboard.reaction.thinking": "思考中",
  "dashboard.reaction.working": "工作中",
  "dashboard.reaction.editing": "编辑中",
  "dashboard.reaction.running": "运行中",
  "dashboard.reaction.testing": "测试中",
  "dashboard.reaction.waiting": "等待中",
  "dashboard.reaction.waving": "挥手",
  "dashboard.reaction.success": "成功",
  "dashboard.reaction.error": "错误",
  "dashboard.reaction.celebrating": "庆祝",
  ...
  "settings.general.showOnLaunch.description": "将 小灰狼桌宠 保留在托盘中，但在需要前隐藏宠物。",
  "settings.general.launchAtLogin.title": "开机自启动",
  "settings.general.launchAtLogin.supported": "在电脑启动时自动启动 小灰狼桌宠。",
  "settings.general.launchAtLogin.unsupported": "此平台不支持。",
  "settings.general.analytics.title": "分享保护隐私的使用分析",
  "settings.general.analytics.description": "帮助改进 小灰狼桌宠。我们不会收集提示词、代码、文件路径、终端命令、宠物气泡文本或插件配置值。",
  ...
  "settings.toast.confinementSaved": "窗口限制已保存。",
  "settings.toast.crossDisplaySaved": "跨显示器漫游已保存。",
  "settings.toast.gravitySaved": "重力设置已保存。",
  "settings.toast.petPoolSaved": "会话池已保存。",
  "settings.petConfinement.label": "限制宠物在其窗口内",
  "settings.petConfinement.description": "开启后，宠物在其终端窗口可见时将保持在窗口内。",
  "settings.petCrossDisplay.label": "允许宠物在多个显示器上",
  "settings.petCrossDisplay.description": "开启后，宠物可以在所有连接的显示器上自由漫游。关闭以将每个宠物限制在单个屏幕上。",
  "settings.petCrossDisplay.helperNoMover": "需要启用 Walkabout 等移动插件。",
  "settings.petGravity.label": "为宠物启用重力",
  "settings.petGravity.description": "开启后，所有宠物将受重力影响下落。默认关闭。",
  "settings.movement.title": "移动",
  "settings.petPool.label": "每个会话使用不同的宠物",
  "settings.petPool.description": "开启后，每个并发代理会话将从池中获取自己的宠物。",
  ...
  "settings.lan.clients": "客户端",
  "settings.lan.topology": "拓扑结构",
  "settings.lan.topologyConfigured": "{hosts} 个主机 / {links} 条链路",
  "settings.lan.topologyFallback": "名称循环",
  "settings.lan.topologyWarnings": "拓扑警告",
  "settings.lan.topologyWarningsDescription": "检查可能导致意外边缘切换的映射。",
  "settings.lan.topologySelfReference": "主机不能切换到自身。",
  "settings.lan.topologyMissingReverse": "添加 {neighbor}.{reverse} = {host} 以实现双向物理布局。",
  "settings.lan.warning": "警告",
  "settings.lan.none": "无",
  "settings.lan.connectedHosts": "已连接主机",
  "settings.lan.connectedHostsDescription": "当前已注册到协调器的机器。",
  "settings.lan.noPosition": "未报告位置",
  "settings.lan.owner": "所有者",
  "settings.lan.connected": "已连接",
  "settings.lan.noClients": "无 LAN 客户端",
  "settings.lan.noClientsDescription": "启动 LAN 服务器/客户端模式以填充此列表。",
  ...
  "plugins.developer.eyebrow": "开发者模式",
  "plugins.developer.show": "显示",
  "plugins.developer.hide": "隐藏",
  "plugins.developer.description": "加载插件项目文件夹。小灰狼桌宠会验证它、快照声明的文件、监视文件夹，并在编辑后重新加载。",
  "plugins.developer.loadUnpacked": "加载文件夹",
  ...
  "plugins.inspector.sourceFolder": "源文件夹",
  ...
  "plugins.inspector.refreshFromFolder": "从文件夹刷新",
  ...
  "plugins.config.defaultSound": "默认提示音",
  "plugins.config.browseSound": "浏览…",
  "plugins.config.useDefaultSound": "使用默认",
  "plugins.config.clearSound": "清除",
  ...
  "plugins.toast.soundImported": "声音已导入。",
  "plugins.toast.commandRan": "插件命令已运行。",
  "plugins.toast.pluginReloaded": "插件已重新加载。",
  "plugins.toast.localRefreshed": "本地插件已从文件夹刷新。",
  ...
  "plugins.busy.refreshingSource": "刷新源中",
  ...
  "integrations.claude.description": "将 Claude Code 连接到你的 小灰狼桌宠 伙伴。",
  "integrations.opencode.name": "OpenCode",
  "integrations.opencode.description": "将 OpenCode 全局连接到你的 小灰狼桌宠 伙伴。",
  "integrations.cursor.name": "Cursor",
  "integrations.cursor.description": "通过全局 MCP 配置将 Cursor 连接到你的 小灰狼桌宠 伙伴。",
  "integrations.pi.name": "Pi",
  "integrations.pi.status": "手动",
  "integrations.pi.description": "通过 小灰狼桌宠 Pi 扩展包连接 Pi 编程代理活动。",
  ...
  "integrations.commandModeHelp": "常规设置请使用已发布的包，桌面应用构建请使用内置版，开发 小灰狼桌宠 时请使用本地版。",
  ...
  "integrations.pi.intro": "从 Pi 安装 小灰狼桌宠 Pi 扩展，然后在 Pi 会话中使用斜杠命令。",
  ...
  "integrations.pi.outro": "全局安装适用于所有 Pi 工作区，项目安装则仅在当前项目中启用 小灰狼桌宠。",
  ...
  "settings.language.description": "小灰狼桌宠 菜单和窗口的显示语言。",
