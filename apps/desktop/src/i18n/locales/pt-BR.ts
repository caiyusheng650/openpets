...
export const ptBR: Partial<Messages> = {
  ...
  "dashboard.reaction.idle": "Ocioso",
  "dashboard.reaction.thinking": "Pensando",
  "dashboard.reaction.working": "Trabalhando",
  "dashboard.reaction.editing": "Editando",
  "dashboard.reaction.running": "Executando",
  "dashboard.reaction.testing": "Testando",
  "dashboard.reaction.waiting": "Esperando",
  "dashboard.reaction.waving": "Acenando",
  "dashboard.reaction.success": "Sucesso",
  "dashboard.reaction.error": "Erro",
  ...
  "settings.toast.confinementSaved": "Confinamento de janela salvo.",
  "settings.toast.crossDisplaySaved": "Navegação entre telas salva.",
  "settings.toast.gravitySaved": "Configuração de gravidade salva.",
  "settings.toast.petPoolSaved": "Pool de sessão salvo.",
  "settings.petConfinement.label": "Limitar o pet à sua janela",
  "settings.petConfinement.description": "Quando ativado, o pet permanece dentro de sua janela de terminal enquanto ela estiver visível.",
  "settings.petCrossDisplay.label": "Permitir pets em múltiplos monitores",
  "settings.petCrossDisplay.description": "Quando ativado, os pets podem se mover livremente por todos os monitores conectados. Desative para restringir cada pet a uma única tela.",
  "settings.petCrossDisplay.helperNoMover": "Requer um plugin de movimento como o Walkabout.",
  ...
  "settings.movement.title": "Movimento",
  "settings.petPool.label": "Usar um pet diferente por sessão",
  "settings.petPool.description": "Quando ativado, cada sessão concorrente do agente obtém seu próprio pet do pool.",
