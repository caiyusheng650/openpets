...
export const ja: Partial<Messages> = {
  ...
  "dashboard.reaction.idle": "アイドル",
  "dashboard.reaction.thinking": "思考中",
  "dashboard.reaction.working": "作業中",
  "dashboard.reaction.editing": "編集中",
  "dashboard.reaction.running": "実行中",
  "dashboard.reaction.testing": "テスト中",
  "dashboard.reaction.waiting": "待機中",
  "dashboard.reaction.waving": "手を振る",
  "dashboard.reaction.success": "成功",
  "dashboard.reaction.error": "エラー",
  "dashboard.reaction.celebrating": "祝う",
  ...
  "settings.toast.confinementSaved": "ウィンドウの閉じ込め設定を保存しました。",
  "settings.toast.crossDisplaySaved": "ディスプレイ間の移動設定を保存しました。",
  "settings.toast.gravitySaved": "重力設定を保存しました。",
  "settings.toast.petPoolSaved": "セッションプール設定を保存しました。",
  "settings.petConfinement.label": "ペットをウィンドウ内に制限",
  "settings.petConfinement.description": "オンにすると、ペットはターミナルウィンドウが表示されている間、ウィンドウ内に留まります。",
  "settings.petCrossDisplay.label": "複数のモニターでペットを許可",
  "settings.petCrossDisplay.description": "オンにすると、ペットは接続されているすべてのディスプレイを自由に移動できます。オフにすると、各ペットは単一の画面に制限されます。",
  "settings.petCrossDisplay.helperNoMover": "Walkabout などの移動プラグインを有効にする必要があります。",
  "settings.petGravity.label": "ペットに重力を適用",
  "settings.petGravity.description": "オンにすると、すべてのペットに重力が適用されます。デフォルトはオフです。",
  "settings.movement.title": "移動",
  "settings.petPool.label": "セッションごとに異なるペットを使用",
  "settings.petPool.description": "オンにすると、各並行エージェントセッションはプールから独自のペットを取得します。",
