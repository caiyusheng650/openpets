...
export const ko: Partial<Messages> = {
  ...
  "dashboard.reaction.idle": "유휴",
  "dashboard.reaction.thinking": "생각 중",
  "dashboard.reaction.working": "작업 중",
  "dashboard.reaction.editing": "편집 중",
  "dashboard.reaction.running": "실행 중",
  "dashboard.reaction.testing": "테스트 중",
  "dashboard.reaction.waiting": "대기 중",
  "dashboard.reaction.waving": "흔들기",
  "dashboard.reaction.success": "성공",
  "dashboard.reaction.error": "오류",
  "dashboard.reaction.celebrating": "축하",
  ...
  "settings.toast.confinementSaved": "창 제한 설정이 저장되었습니다.",
  "settings.toast.crossDisplaySaved": "다중 디스플레이 이동 설정이 저장되었습니다.",
  "settings.toast.gravitySaved": "중력 설정이 저장되었습니다.",
  "settings.toast.petPoolSaved": "세션 풀 설정이 저장되었습니다.",
  "settings.petConfinement.label": "펫을 창 내부에 제한",
  "settings.petConfinement.description": "활성화 시, 펫은 터미널 창이 표시되는 동안 창 내부에 유지됩니다.",
  "settings.petCrossDisplay.label": "다중 모니터에서 펫 허용",
  "settings.petCrossDisplay.description": "활성화 시, 펫은 연결된 모든 디스플레이를 자유롭게 이동할 수 있습니다. 비활성화하면 각 펫이 단일 화면으로 제한됩니다.",
  "settings.petCrossDisplay.helperNoMover": "Walkabout과 같은 이동 플러그인을 활성화해야 합니다.",
  "settings.petGravity.label": "펫에 중력 적용",
  "settings.petGravity.description": "활성화 시, 모든 펫이 중력에 따라 떨어집니다. 모든 펫에 적용됩니다. 기본값은 비활성화입니다.",
  "settings.movement.title": "이동",
  "settings.petPool.label": "세션마다 다른 펫 사용",
  "settings.petPool.description": "활성화 시, 각 동시 에이전트 세션은 풀에서 자신의 펫을 가져옵니다.",
