...
export const es419: Partial<Messages> = {
  ...
  "dashboard.reaction.idle": "Inactivo",
  "dashboard.reaction.thinking": "Pensando",
  "dashboard.reaction.working": "Trabajando",
  "dashboard.reaction.editing": "Editando",
  "dashboard.reaction.running": "Ejecutando",
  "dashboard.reaction.testing": "Probando",
  "dashboard.reaction.waiting": "Esperando",
  "dashboard.reaction.waving": "Saludando",
  "dashboard.reaction.success": "Éxito",
  "dashboard.reaction.error": "Error",
  "dashboard.reaction.celebrating": "Celebrando",
  ...
  "settings.toast.confinementSaved": "Confinamiento de ventana guardado.",
  "settings.toast.crossDisplaySaved": "Navegación entre pantallas guardada.",
  "settings.toast.gravitySaved": "Configuración de gravedad guardada.",
  "settings.toast.petPoolSaved": "Grupo de sesiones guardado.",
  "settings.petConfinement.label": "Limitar la mascota a su ventana",
  "settings.petConfinement.description": "Al activarse, la mascota permanece dentro de su ventana de terminal mientras esta sea visible.",
  "settings.petCrossDisplay.label": "Permitir mascotas en múltiples monitores",
  "settings.petCrossDisplay.description": "Al activarse, las mascotas pueden moverse libremente por todas las pantallas conectadas. Desactiva para restringir cada mascota a una sola pantalla.",
  "settings.petCrossDisplay.helperNoMover": "Requiere un complemento de movimiento como Walkabout.",
  ...
  "settings.movement.title": "Movimiento",
  "settings.petPool.label": "Usar una mascota diferente por sesión",
  "settings.petPool.description": "Al activarse, cada sesión concurrente del agente obtiene su propia mascota del grupo.",
