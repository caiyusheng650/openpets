...
export const zhHant: Partial<Messages> = {
  ...
  "dashboard.reaction.idle": "閒置",
  "dashboard.reaction.thinking": "思考中",
  "dashboard.reaction.working": "工作中",
  "dashboard.reaction.editing": "編輯中",
  "dashboard.reaction.running": "執行中",
  "dashboard.reaction.testing": "測試中",
  "dashboard.reaction.waiting": "等待中",
  "dashboard.reaction.waving": "揮手",
  "dashboard.reaction.success": "成功",
  "dashboard.reaction.error": "錯誤",
  "dashboard.reaction.celebrating": "慶祝",
  ...
  "settings.toast.confinementSaved": "視窗限制已儲存。",
  "settings.toast.crossDisplaySaved": "跨顯示器漫遊已儲存。",
  "settings.toast.gravitySaved": "重力設定已儲存。",
  "settings.toast.petPoolSaved": "工作階段集區已儲存。",
  "settings.petConfinement.label": "限制寵物在其視窗內",
  "settings.petConfinement.description": "開啟後，寵物在其終端視窗可見時將保持在視窗內。",
  "settings.petCrossDisplay.label": "允許寵物在多個顯示器上",
  "settings.petCrossDisplay.description": "開啟後，寵物可以在所有連接的顯示器上自由漫遊。關閉以將每個寵物限制在單個螢幕上。",
  "settings.petCrossDisplay.helperNoMover": "需要啟用 Walkabout 等移動外掛。",
  "settings.petGravity.label": "為寵物套用重力",
  "settings.petGravity.description": "開啟後，所有寵物將受重力影響。預設為關閉。",
  "settings.movement.title": "移動",
  "settings.petPool.label": "每個工作階段使用不同的寵物",
  "settings.petPool.description": "開啟後，每個並發代理工作階段將從集區中取得自己的寵物。",
